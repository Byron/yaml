...
#[automatically_derived]
impl ::serde::de::Deserialize for SingleOptKey {
    fn deserialize<__D>(deserializer: &mut __D)
     -> ::std::result::Result<SingleOptKey, __D::Error> where
     __D: ::serde::de::Deserializer {
        {
            #[allow(non_camel_case_types)]
            ...
            impl <__D: ::serde::de::Deserializer> ::serde::de::Visitor for
             __Visitor<__D> {
                ...
                #[inline]
                fn visit_map<__V>(&mut self, mut visitor: __V)
                 -> ::std::result::Result<SingleOptKey, __V::Error> where
                 __V: ::serde::de::MapVisitor {
                    {
                        let mut __field0 = None;
                        loop  {
                        ...
                        let __field0 =
                            match __field0 {
                                Some(__field0) => __field0,
                                None =>
                                try!(visitor . missing_field ( "key" )),
                            };
                        try!(visitor . end (  ));
                        Ok(SingleOptKey{key: __field0,})
                    }
                }
            }
            deserializer.visit_named_map("SingleOptKey",
                                         __Visitor::<__D>(::std::marker::PhantomData))
        }
    }
}
#[automatically_derived]
impl ::serde::ser::Serialize for SingleOptKey {
    fn serialize<__S>(&self, serializer: &mut __S)
     -> ::std::result::Result<(), __S::Error> where
     __S: ::serde::ser::Serializer {
        {
            ...
            serializer.visit_named_map("SingleOptKey",
                                       Visitor{value: self, state: 0,})
        }
    }
}
...
#[automatically_derived]
impl ::serde::de::Deserialize for DualOptKey {
    fn deserialize<__D>(deserializer: &mut __D)
     -> ::std::result::Result<DualOptKey, __D::Error> where
     __D: ::serde::de::Deserializer {
        {
            #[allow(non_camel_case_types)]
            enum __Field { __field0, __field1, }
                    ...
                    impl <__D> ::serde::de::Visitor for __FieldVisitor<__D>
                     where __D: ::serde::de::Deserializer {
                        ...
                        fn visit_str<E>(&mut self, value: &str)
                         ...
                         E: ::serde::de::Error {
                            match value {
                                "key1" => { Ok(__Field::__field0) }
                                "key2" => { Ok(__Field::__field1) }
                                _ => {
                                    Err(::serde::de::Error::unknown_field_error(value))
                                }
                            }
            ...
            impl <__D: ::serde::de::Deserializer> ::serde::de::Visitor for
             __Visitor<__D> {
                ...
                #[inline]
                fn visit_map<__V>(&mut self, mut visitor: __V)
                 -> ::std::result::Result<DualOptKey, __V::Error> where
                 __V: ::serde::de::MapVisitor {
                    {
                        let mut __field0 = None;
                        let mut __field1 = None;
                        ...
                        let __field0 =
                            match __field0 {
                                Some(__field0) => __field0,
                                None =>
                                try!(visitor . missing_field ( "key1" )),
                            };
                        let __field1 =
                            match __field1 {
                                Some(__field1) => __field1,
                                None =>
                                try!(visitor . missing_field ( "key2" )),
                            };
                        try!(visitor . end (  ));
                        Ok(DualOptKey{key1: __field0, key2: __field1,})
                    }
                }
            }
            deserializer.visit_named_map("DualOptKey",
                                         __Visitor::<__D>(::std::marker::PhantomData))
        }
    }
}
#[automatically_derived]
impl ::serde::ser::Serialize for DualOptKey {
    fn serialize<__S>(&self, serializer: &mut __S)
     -> ::std::result::Result<(), __S::Error> where
     __S: ::serde::ser::Serializer {
        {
                 ...
                 S: ::serde::ser::Serializer {
                    match self.state {
                        0usize => {
                            self.state += 1;
                            Ok(Some(try!(serializer . visit_map_elt (
                                         "key1" , &self.value.key1 , ))))
                        }
                        1usize => {
                            self.state += 1;
                            Ok(Some(try!(serializer . visit_map_elt (
                                         "key2" , &self.value.key2 , ))))
                        }
                        _ => Ok(None),
                    }
                }
            ...
            serializer.visit_named_map("DualOptKey",
                                       Visitor{value: self, state: 0,})
        }
    }
}

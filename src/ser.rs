...
// TODO(ST): make serde_macros work and use #[cfg(test)] instead
// or get syntex to work with cfg(test).
// https://github.com/erickt/rust-syntex/issues/9
mod tests {
    ...
    fn serialization() {
        ...
        assert_eq!(to_string_pretty(&d).unwrap(), 
r#"i32: 0,
i64: 0,
u32: 0,
u64: 0,
